...
#define S_L_SUFFIX_STATE 12
#define U_L_SUFFIX_STATE 13
#define L_L_SUFFIX_STATE 14
#define OCTAL_STATE 15
#define HEX_STATE 16
#define DOUBLE_STATE 17
#define F_SUFFIX_STATE 18
#define EXPONENT_STATE 19
#define S_EXPONENT_STATE 20
#define F_NUM_SUFFIXES_STATE 21
#define E_DOUBLE_STATE 22
#define L_D_SUFFIX_STATE 23
    ...
    while(1)
    {
        switch(curr_state)
        {
            ...
            case MINUS_SIGN_STATE:
                ...
                break;
            //TODO: Change U_ZERO_STATE to the current P_ZERO_STATE and adjust the lines accordingly
            case P_ZERO_STATE:
                ...
                break;
            //TODO: Change S_ZERO_STATE to the current M_ZERO_STATE
            case M_ZERO_STATE:
